Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/dlowder-salesforce/OpenSSL.git", :tag => "#{s.version}" }
  ...
  s.subspec 'Static' do |sp|
    ...
    sp.tvos.source_files        = 'tvos/include/openssl/**/*.h'
    sp.tvos.public_header_files = 'tvos/include/openssl/**/*.h'
    sp.tvos.header_dir          = 'openssl'
    sp.tvos.preserve_paths      = 'tvos/lib/libcrypto.a', 'tvos/lib/libssl.a'
    sp.tvos.vendored_libraries  = 'tvos/lib/libcrypto.a', 'tvos/lib/libssl.a'
