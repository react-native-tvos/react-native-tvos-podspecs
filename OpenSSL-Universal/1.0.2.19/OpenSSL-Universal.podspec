Pod::Spec.new do |s|
  ...
  s.subspec 'Static' do |sp|
    ...
    sp.tvos.deployment_target = '6.0'
    sp.tvos.source_files        = 'ios/include/openssl/**/*.h'
    sp.tvos.public_header_files = 'ios/include/openssl/**/*.h'
    sp.tvos.header_dir          = 'openssl'
    sp.tvos.preserve_paths      = 'ios/lib/libcrypto.a', 'ios/lib/libssl.a'
    sp.tvos.vendored_libraries  = 'ios/lib/libcrypto.a', 'ios/lib/libssl.a'
